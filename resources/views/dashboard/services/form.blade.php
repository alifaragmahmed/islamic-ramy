            ...
            <form class="form" action="{{ $resource->id ? route('admin.service.update', $resource->id) : route('admin.service.store') }}"
                ...
                <div class="row">
                    <div class="col-6  ">
                        ...
                        {!! Form::label('image', __('lang.image') .' 370 * 224' , ['class' => 'form-label'] ) !!} <br>
                    ...
                    <div class="col-6  ">
                        ...
                        <img class=" image-preview-icon  " width="100%" height="200"   src="{{ asset($resource->image ?? 'assets/img/default.jpg' ) }}">
                        <br>
