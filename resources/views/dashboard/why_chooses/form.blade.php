...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form class="form" action="{{ $resource->id ? route('admin.why_chooses.update', $resource->id) : route('admin.why_chooses.store') }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12  ">

                    {!! Form::label('image', __('lang.image') . ' 70 * 62' , ['class' => 'form-label'] ) !!} <br>
