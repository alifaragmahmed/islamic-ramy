...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
        ...
        <div class="modal-body">
            <form class="form"
                action="{{ $resource->id ? route('admin.gallery.update', $resource->id) : route('admin.gallery.store') }}"
                method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 pt-2">

                        {!! Form::label('image', __('lang.image') . ' 370 * 456', ['class' => 'form-label']) !!} <br>
                        <img class=" image-preview-image m-auto rounded-circle" width="80" height="80"
                    ...
                    <div class="col-12 pt-2">
                        {!! Form::label('type', __('lang.type'), ['class' => 'form-label']) !!}
                        {!! Form::select('type', ['0' => __('lang.image'), '1' => __('lang.video')], $resource->type, ['class' => 'form-control type-video', 'onchange' => 'setType(this.value)']) !!}

                    </div>

                    <div class="col-12 pt-2 d-none link-video">
                        {!! Form::label('link', __('lang.link'), ['class' => 'form-label']) !!}
                        {!! Form::text('link', $resource->link, ['class' => 'form-control']) !!}
                    </div>
