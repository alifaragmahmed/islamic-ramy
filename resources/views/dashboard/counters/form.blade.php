...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
        ...
        <div class="modal-body">
            <form class="form" action="{{ $resource->id ? route('admin.counter.update', $resource->id) : route('admin.counter.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6  ">
                    ...
                    <div class="col-6  ">
                        ...
                        {!! Form::label('color', __('lang.color'), ['class' => 'form-label']) !!} <br>

                        {!! Form::color('color', old('color', $resource->color), ['class' => 'form-control']) !!}
