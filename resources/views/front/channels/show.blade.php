        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 mb-3">
                    ...
                    <div class="video p-0 mb-2 w3-round-large wow animate__animated animate__backInDown">
                        <div style="background-image: url({{ asset($resource->master_image) }})" class="frame rounded-bottom-0 w3-round-large cursor-pointer">
                            {!! $resource->embeded_text !!}
                        </div>
                    </div>

                    <div class="video p-0  w3-round-large">
                        ...
                        <div class="caption">
                            ...
                            <div class="d-flex p-2 align-items-center justify-content-center w3-round-large border-1 w3-border w3-border-light-gray">
                                <div class="flex-shrink-0">
                                    <img class="wow animate__animated animate__slideInRight" height="70px" src="{{ asset('front/img/sheikh-ramy-profile.png') }}" alt="">
                                </div>
                                <div class="flex-grow-1 wow animate__animated animate__slideInLeft">
                                    <h6>الشيخ رامي أبو زريد</h6>
                                    <strong class="w3-tiny">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                    <div class="video mb-4 w3-round-large p-3 w3-white wow w3-animate-zoom">
                    ...
                    <div class="video  w3-round-large p-3 w3-white">
                        ...
                        @foreach ($relatedVideos as $video)
                            <div class="video shadow-none p-0 wow animate__animated animate__backInUp ">
