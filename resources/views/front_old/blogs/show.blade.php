    ...
    <div class="container-fluid page-header p-0     " style="background-image: url({{ asset($metaBanner->image) }}); {{ isMobile()?'height:150px':'' }} " data-wow-delay="0.1s">
        <div class="meta--banner" >
            <div class="container py-5">
                <h1 class=" animated slideInDown text-end mb-4">{{isRtl()? $metaBanner->title :  $metaBanner->title_en}}</h1>
                            ...
                            @foreach ($latestBlogs as $item)
                                <div class="col-12 pt-3">
                                    <div class="card mb-3" style="">
                                        <div class="row g-0">
                                          <div class="col-md-4">
                                            <img loading="lazy" src="{{ asset($item->image) }}" style="height: 100%" class="img-fluid rounded-start" alt="...">
                                          </div>
                                          <div class="col-md-8">
