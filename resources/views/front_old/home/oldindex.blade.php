...
<head>
    ...
    <title> SafZon - Security Guard Bootstrap 5 Template</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="cuscol">
                        <div class="logo">
                            <a href="index.html">
                                <img src="frontassets/images/logo/logo.png" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
...
<div class="hero-section section">
    ...
    <div class="hero-slider hero-slider-one">
        <div class="hero-slide-item d-flex align-items-center image-bg" style="background-image: url(frontassets/images/hero/hero-1.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
        ...
        <div class="hero-slide-item d-flex align-items-center image-bg" style="background-image: url(frontassets/images/hero/hero-2.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="row-service-wrap_white">
                        <div class="service text-start service-6 medical-service">
                            <div class="icons">
                                <img src="frontassets/images/icon/service-01.png" alt="service icons">
                            </div>
                            <div class="content">
                                <h4>Webcam Security</h4>
                                <p>Access complete visability through your phone or device. We provide a complete range of security solutions, day and night vision to improve security & enhance capabilities.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="service text-start service-6 medical-service service-bg-2">
                        <div class="icons">
                            <img src="frontassets/images/icon/service-02.png" alt="service icons">
                        </div>
                        <div class="content">
                            <h4>Security Guard</h4>
                            <p>Alarm services to suit the right environment. From wired to wireless systems, Remote Monitored and Intergrating systems. We Instal all alarms to suit the need of the location.</p>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                   <div class="row-service-wrap_white">
                    <div class="service text-start service-6 medical-service">
                        <div class="icons">
                            <img src="frontassets/images/icon/service-03.png" alt="service icons">
                        </div>
                        <div class="content">
                            <h4>Motivated Guards</h4>
                            <p>Combining identification technology with security solutions to give you a high level of protection, whether your business has a single or muliti-site entry points.</p>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                   <div class="row-service-wrap">
                    <div class="service text-start service-6 medical-service service-bg-2">
                        <div class="icons">
                            <img src="frontassets/images/icon/service-04.png" alt="service icons">
                        </div>
                        <div class="content">
                            <h4>24/7 Services</h4>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="agency-thumb">
                        <div class="thumb">
                            <img src="frontassets/images/about/about-01.png" alt="Agency Images">
                            <div class="play-btn">
                    ...
                    <div class="service text-center service-2 padding-none cleaning-service mb-30">
                        <div class="thumb">
                            <a href="service-details.html">
                                <img src="{{ asset('frontassets/images/serviece/service-01.jpg') }}" alt="service img">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="reapir-choose-inner">
                        ...
                        <div class="choose-resone-inner mt-20">
                            ...
                            <div class="service text-start service-6 reapir-service mt-30">
                                <div class="icons">
                                    <img src="frontassets/images/icon/c-01.png" alt="service icons">
                                </div>
                                <div class="content">
                                    <h4>Free Estimate</h4>
                            ...
                            <div class="service text-start service-6 reapir-service">
                                <div class="icons">
                                    <img src="frontassets/images/icon/c-02.png" alt="service icons">
                                </div>
                                <div class="content">
                                    <h4>24/7 Services</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipi elit sed do eiusmod tempor incididunt ut labor et dolore magna aliqua. </p>
                            ...
                            <div class="service text-start service-6 reapir-service">
                                <div class="icons">
                                    <img src="frontassets/images/icon/c-03.png" alt="service icons">
                                </div>
                                <div class="content">
        ...
        <div class="container">
            ...
            <div class="row pb-60 testimonial-carousel-3">
                <div class="col-lg-6">
                    ...
                    <div class="testimonial-style-3  testimonial-grid-2">
                        <div class="testimonal">
                            <img src="frontassets/images/testimoniail/01.png" alt="testimonal image">
                            <div class="content">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="testimonial-style-3 testimonial-grid-2">
                        <div class="testimonal">
                            <img src="frontassets/images/testimoniail/02.png" alt="testimonal image">
                            <div class="content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicill elit, sed do eiusmo
                                    tempor incididunt ut labore etll dolore magna aliqua Ut enim.</p>
                                <div class="clint-info">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="team team-8 mb-30">
                        <div class="thumb">
                            <a href="#">
                                <img src="frontassets/images/team/team-01.jpg" alt="team img">
                            </a>
                        </div>
                        <div class="team-info">
                            <div class="content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="team team-8 mb-30">
                        <div class="thumb">
                            <a href="#">
                                <img src="frontassets/images/team/team-02.jpg" alt="team img">
                            </a>
                        </div>
                        <div class="team-info">
                            <div class="content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="team team-8 mb-30">
                        <div class="thumb">
                            <a href="#">
                                <img src="frontassets/images/team/team-03.jpg" alt="team img">
                            </a>
                        </div>
                        <div class="team-info">
                            <div class="content">
            ...
            <div class="row post-carousel-wrapper post-carousel-active-5 ">
                    ...
                    <div class="post-carousel mb-30">
                        <div class="thumb">
                            <a href="blog-details.html">
                                <img src="frontassets/images/blog/thum-01.jpg" alt="elementor">
                            </a>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="post-carousel mb-30">
                        <div class="thumb">
                            <a href="blog-details.html">
                                <img src="frontassets/images/blog/thum-02.jpg" alt="elementor">
                            </a>
                        </div>
                        <div class="ptc-content">
                            <h4><a href="blog-details.html">Motivated Guards sit amet.</a></h4>
                            <ul class="meta d-flex">
                                <li><a href="#"><i class="zmdi zmdi-calendar-check"></i> Sep 12, 2018</a></li>
                                <li><i class="zmdi zmdi-account-calendar"></i> By : <a href="#">Admin</a></li>
                            </ul>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do eius
                                tempor incididu ut labore et dolore</p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="post-carousel mb-30">
                        <div class="thumb">
                            <a href="blog-details.html">
                                <img src="frontassets/images/blog/thum-03.jpg" alt="elementor">
                            </a>
                        </div>
                        <div class="ptc-content">
                            <h4><a href="blog-details.html">Lorem ipsum dolor sit amet.</a></h4>
                            <ul class="meta d-flex">
                                <li><a href="#"><i class="zmdi zmdi-calendar-check"></i> Sep 16, 2019</a></li>
                                <li><i class="zmdi zmdi-account-calendar"></i> By : <a href="#">Admin</a></li>
                            </ul>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do eius
                                tempor incididu ut labore et dolore</p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="post-carousel mb-30">
                        <div class="thumb">
                            <a href="blog-details.html">
                                <img src="frontassets/images/blog/thum-05.jpg" alt="elementor">
                            </a>
                        </div>
                        <div class="ptc-content">
                            <h4><a href="blog-details.html">Lorem ipsum dolor sit amet.</a></h4>
                            <ul class="meta d-flex">
                                <li><a href="#"><i class="zmdi zmdi-calendar-check"></i> Sep 13, 2019</a></li>
                                <li><i class="zmdi zmdi-account-calendar"></i> By : <a href="#">Admin</a></li>
                            </ul>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisici elit, sed do eius
                                tempor incididu ut labore et dolore</p>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="copyright-left content text-center">
                        <p>Copyright &copy; by <a href="#"></a>Safzon</a>. All right reserved</p>
                    </div>
                </div>
