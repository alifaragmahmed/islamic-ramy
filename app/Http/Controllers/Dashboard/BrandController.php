...
class BrandController extends Controller
{
    ...
    public function store(StoreBrand $request)
    {
        ...
        if (isset($inputs['image'])) {
            $inputs['image'] = uploadImage($inputs['image'], config('path.BRAND_PATH'), $inputs['ar']['title']);
        }
        // dd($inputs);
    ...
    public function update(StoreBrand $request, $id)
    {
        ...
        $resource = $this->model->findOrFail($id);
        if (isset($inputs['image'])) {
            $inputs['image'] = uploadImage($inputs['image'], config('path.BRAND_PATH'), $inputs['ar']['title'], $resource->image);
        }
