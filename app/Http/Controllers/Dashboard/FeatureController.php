...
class FeatureController extends Controller
{
    ...
    public function store(StoreFeature $request)
    {
        ...
        $inputs['image'] = uploadImage($inputs['image'], config('path.FEATURE_PATH'), $inputs['ar']['title']);
    ...
    public function update(StoreFeature $request, $id)
    {
        ...
        if (isset($inputs['image'])) {
            $inputs['image'] = uploadImage($inputs['image'], config('path.FEATURE_PATH'), $inputs['ar']['title'], $resource->image);
        }
