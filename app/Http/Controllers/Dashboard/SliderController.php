...
class SliderController extends Controller
{
    ...
    public function store(StoreSlider $request)
    {
        ...
        if (isset($inputs['image'])) {
            $inputs['image'] = uploadImage($inputs['image'], config('path.SLIDER_PATH'), $inputs['ar']['title']);
        }
        // dd($inputs);
    ...
    public function update(StoreSlider $request, $id)
    {
        ...
        $resource = $this->model->findOrFail($id);
        if (isset($inputs['image'])) {
            $inputs['image'] = uploadImage($inputs['image'], config('path.SLIDER_PATH'), $inputs['ar']['title'], $resource->image);
        }
        // dd($inputs);
