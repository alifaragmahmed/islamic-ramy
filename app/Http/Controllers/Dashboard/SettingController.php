...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if (isset($inputs['intro_image'])) {
            $inputs['intro_image'] = uploadImage($inputs['intro_image'], config('path.SETTING_PATH'), '', optional($setting->where('key', 'intro_image')->first())->value);
        }
        ...
        // upload video intro_video
        if (isset($inputs['intro_video'])) {
            $inputs['intro_video'] = uploadImage($inputs['intro_video'], config('path.SETTING_PATH'), '', optional($setting->where('key', 'intro_video')->first())->value);
        }
